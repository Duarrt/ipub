...
//recebendo as variáveis inseridas
    ...
    //inserindo os dados na tabela "membros"    
    $query_select = "SELECT usuario FROM membros WHERE usuario = '$usuario'";
      ...
      if($usuario == "" || $usuario == null){
        echo"<script language='javascript' type='text/javascript'>alert('O campo login deve ser preenchido');window.location.href='index.php?id=cad';</script>";
          ...
          if($logarray == $usuario){
            ...
            $query = "INSERT INTO membro (nome, cpf, telefone, endereco, sexo, data_nasc, email, usuario, senha, nivel)VALUES('$nome','$cpf','$telefone','$endereco','$sexo','$data','$email', '$usuario', '$senha', 3)";
